...
return array(
    ...
    "move_ticket"               => "Flytta ärende",
    "move_ticket_step1"         => "Steg 1: Välj ett nytt varumärke att flytta ärendet till",
    "move_ticket_step2"         => "Steg 2: Välj en avdelning från nya varumärket",
    "current_record"            => "Nuvarande :record",
    "new_record"                => "Ny :record",
    "department_email"          => "Avdelningens e-postadress",
    "select_a_department_email" => "Välj en e-postadress för avdelningen...",
    "record_public_desc"        => "Växla till att endast låta :record vara tillgängligt för dig själv.",
    "record_group_desc"         => "Om du vill göra :record synlig för endast vissa operatörsgrupper. Lämna tomt för att göra den synlig för alla operatörer.",
