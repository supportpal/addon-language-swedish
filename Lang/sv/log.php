...
return array(
    ...
    "export_generated"                  => "Export :new_value av användare :rel har genererats och lagrats i systemet.",
    "export_deleted"                    => "Export :old_value av användare :rel har raderats från systemet.",
